...
export default function HomeCockpit({
  ...
  return (
    <div className="cockpit space-y-3">
      ...
      <section className="cockpit-surface flex flex-col gap-3 rounded-2xl border border-sky-500/20 bg-gradient-to-r from-sky-500/[0.07] via-gray-900/75 to-gray-900/75 px-4 py-3 sm:flex-row sm:items-center sm:px-5">
        ...
        <div className="min-w-0 flex-1">
          <p className="text-sm font-semibold text-gray-100">Add a capability to this machine</p>
          <p className="mt-0.5 text-[11px] leading-5 text-gray-500">Discover models for chat, images, vision, and speech; check what fits; then download and connect one.</p>
        </div>
        <button
          type="button"
          onClick={() => onSelectTab("models")}
          className="inline-flex shrink-0 items-center justify-center gap-2 rounded-lg bg-sky-500 px-4 py-2 text-xs font-semibold text-white transition hover:bg-sky-400"
        >
          Discover and set up models <ArrowRight size={14} />
        </button>
      </section>
        ...
        <div className="cockpit-hero cockpit-surface overflow-hidden rounded-2xl border border-gray-800 bg-gray-900/75">
          ...
          <div className="px-5 pb-4 pt-4 sm:px-6 sm:pb-5 sm:pt-5">
            <div className="flex flex-wrap items-start justify-between gap-3">
              ...
              >
                <Stack size={15} weight="duotone" className="text-sky-300" />
                Set up models
              </button>
            </div>
